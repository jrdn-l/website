...
export default function Projects() {
  ...
  return (
    <div id="projects">
      ...
      <Modal showModal={showCGAModal} setShowModal={setShowCGAModal} title="Covid Go Away" description={s} />
      ...
      <Card setShowModal={setShowCGAModal} title="Covid Go Away" description='Card game inspired by Sushi Go on the web.' />
