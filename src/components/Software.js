    ...
    return (
        <div className='container'>
            ...
            <p>This was a bot I made in my first year of univeristy. I initially started this 
                ...
                This project introduced me to quite a few things like async calls, coroutines, working with Ubuntu in the command line as well as SSHing into an AWS.
            </p>
            <br/>
            </div>
            <h2>RushMate App</h2>
            <p>Project for School! Inspired by Covid</p>
            <br/>
