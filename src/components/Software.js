        ...
        <div className='container'>
            ...
            <div>
                ...
                <p>This was a bot I made in my first year of univeristy. I initially started this
                    ...
                    This project introduced me to quite a few things like async calls, coroutines, working with Ubuntu in the command line as well as SSHing into an AWS cloud droplet.
                </p>
            ...
            <div>
                <h2>RushMate App</h2>
                <p>Tools and Libraries: Python, JavaScript, React Native, Git, MongoDB, Andriod, iOS, Google API</p>
                <br/>
                <p>This app was a project for School done with a group. Since it was written with React Native, the app works on both
                    iOS and Andriod platforms. Inspired by COVID-19 this app was supposed to help users get to locations that were
